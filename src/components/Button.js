...
const onEpbackIconClick = useCallback(() => {
  ...
  return (
    <section className="button59">
      <div className="item-list-frame" style={{justifyContent:'center', alignItems: 'center'}}>
      ...
      <div className="choose-method-button">
        <div className="buttons-states-dark47">
          <div className="shipping2">
            ...
            <div
              className={`${
                isVisibleSM ? "flex gap-[15px]" : "hidden"
...

                      {
                        ...
                        <div className="frame-parent41">
                          <div className="alberta-wrapper1">
                            <div className="alberta6">{addresslist.city}</div>
                          </div>
                          <div className="location-parent4">
                            <img
                              ...
                              src={location11}
                            />
                            <div className="hospital-st-fort6">
                          ...
                          <div className="call-parent3">
                            <img
                              ...
                              src={call1}
                            />
                            <div className="div19">{addresslist.phone}</div>
                          </div>
                        </div>
                      </div>)
                      }
        ...
        <div className="checkout-details-frame">
          <div className="summary5">
            ...
            <div className="items-quantity-frame1">
              <div className="items3">ITEMS</div>
              <div className="quantity5">Quantity</div>
            </div>
              ...
              <div className="edoneil-avvd-zlh-dow-aunsplash-inner1">
                <div className="frame-parent51">
                  <div className="frame-parent52">
                    ...
                    <div className="frame-parent53">
                      <div className="mango-mojito-wrapper4">
                        <b className="mango-mojito5">{item.menu_items.name}</b>
                      </div>
                      <b className="b20">${(item.total_amount)*item.quantity}</b>
                    </div>
                  </div>
                  <div className="component-119">
                    ...
                    <div className="div22">{item.quantity}</div>
